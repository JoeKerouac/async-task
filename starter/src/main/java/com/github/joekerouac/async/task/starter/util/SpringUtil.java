 ...
 */
package com.github.joekerouac.async.task.starter.util;
...
public class SpringUtil {
    ...
    public static void scanAndRegisterBean(Environment environment, final AnnotationMetadata importingClassMetadata,
        final BeanDefinitionRegistry registry, Class<? extends Annotation>... annotationTypes) {
        Set<String> basePackages = getBasePackages(environment, importingClassMetadata);
     ...
     * @return 用户设置的扫描包配置
     */
    private static Set<String> getBasePackages(Environment environment,
